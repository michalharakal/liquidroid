 ...
 * 
 * Some of the parts are modified to suite with the lqfb application.
 */
public class GravatarImage {

    /** The instance. */
    private static GravatarImage instance;
     ...
     */
    public static GravatarImage getInstance() {
        if (instance == null) {
            instance = new GravatarImage();
        }
        return instance;
    }
    ...
    public void download(String gravatarId, ImageView ivImage) {
        String url = "http://www.gravatar.com/avatar.php?gravatar_id=" + gravatarId
                + "&size=60&d=mm";
    ...
    public void download(String gravatarId, ImageView ivImage, int size) {
        String url = "http://www.gravatar.com/avatar.php?gravatar_id=" + gravatarId + "&size="
                + size + "&d=mm";
    ...
    static Bitmap downloadBitmap(String urlStr) {
        ...
        try {
            ...
            Log.e(liqui.droid.Constants.LOG_TAG, e.getMessage(), e);
        } finally {
            if (is != null) {
                try {
                    is.close();
    ...
    private final HashMap<String, Bitmap> sHardBitmapCache = new LinkedHashMap<String, Bitmap>(
        ...
        private static final long serialVersionUID = -8033580159773716853L;
